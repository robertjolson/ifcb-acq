...
public:
	...
	CString	GetDataTitle( int dataID ) { int i = GetIndex(dataID); if( i < 0 ) return _T(""); else return m_DataTitle[i]; }
...
public:
	...
	void	AddChartTypePopup( CMenu *addMenu, LPCTSTR titleString, long compare, int startVal );
	void	AddLineSizePopup( CMenu *addMenu, LPCTSTR titleString, int dataID, int startVal );
	void	AddLineStylePopup( CMenu *addMenu, LPCTSTR titleString, int dataID, int startVal );
	void	AddMarkerPopup( CMenu *addMenu, LPCTSTR titleString, int dataID, int startVal );
