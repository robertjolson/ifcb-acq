...
*
* \param[in]    CamId       Camera identifier (serial number)
* \param[out]   pLeft       Pointer to new horizontal position - invalid data will be adjusted during function call. NULL will leave position unchanged.
* \param[out]   pTop        Pointer to new vertical position - invalid data will be adjusted during function call. NULL will leave position unchanged.
* \return   <dl><dt>S_OK</dt><dd>if the operation was successful</dd></dl>
*/
