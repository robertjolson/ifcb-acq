...
typedef enum E_UNI_BAYER_PATTERN
{
    ...
    E_BP_LAST=255
} E_UNI_BAYER_PATTERN,E_UniBayerPattern;
...
typedef enum E_UNI_INTERFACE
{
    ...
    E_INTF_LAST=255
} E_UNI_INTERFACE,E_UniInterface;
...
} E_UNI_ENDIANNESS,E_UniEndianness;
...
} E_UNI_ALIGNMENT,E_UniAlignment;
...
//! Enumeration for Free Modes to be used by ::UCC_PrepareGrab.
...
/** Enumeration for output image formats supported by ::GetImage, ::GetImageEx, ::GrabImage and ::GrabImageEx.
...
typedef enum E_UNI_IMAGE_FORMAT
{
    ...
    E_IF_NATIVE_EX,    //!< Native transfer format. The output format may differ between 1394 DCAM and GigE-Vision cameras, even if the same color code is set. ::GetImageEx, ::GrabImageEx and ::GetNativeImageEx return necessary format details as ::S_UNI_TRANSPORT_FORMAT_INFO. Memory requirements depend on the color code. 
...
#define UNI_GIGE_ENUMERATION_DELAY 5000 //2000 //Rob increased to 5000 
...
typedef enum E_UNI_LICENSE_TYPE
{
    ...
    E_T_FRAMELIMITED    = 7     //!< Frame-limited demo license
